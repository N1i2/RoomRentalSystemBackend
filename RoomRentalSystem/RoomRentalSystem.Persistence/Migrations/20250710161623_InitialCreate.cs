        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Booking_Dates", "\"EndDate\" > \"StartDate\" AND (\"EndDate\" - \"StartDate\") <= INTERVAL '365 days' AND (\"EndDate\" - \"StartDate\") >= INTERVAL '1 day'");
                    table.CheckConstraint("CK_Booking_TotalPrice", "\"TotalPrice\" >= 1");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Image_Size", "LENGTH(\"ImageData\") <= 10485760");
                });
